    ...
    return (
        <div className={`sidebar shadow ${sidebar ? "show": ""} ${darkmode ? "sidebar-dark" : ""}`}>
            <ul className="list-group p-4 pt-5 mt-3">
                <NavLink to="/applications"><li className="list-group-item"><svg className="me-3" xmlns="http://www.w3.org/2000/svg" width="25" height="20" viewBox="0 0 16.264 17.433">
                ...
                <NavLink to="/tracks"><li className="list-group-item"><svg className="me-3" xmlns="http://www.w3.org/2000/svg" width="25" height="20" viewBox="0 0 18.895 13.778">
