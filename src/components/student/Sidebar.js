  ...
  return (
        <div className={`sidebar shadow ${sidebar ? 'show' : ''} ${darkmode ? 'sidebar-dark' : ''}`}>
            ...
            <ul className="list-group p-4 pt-4 mt-3">
                ...
                News</li></NavLink>
                <NavLink to="/leadership-board"><li className="list-group-item"> <svg className="me-3" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 100 100" width="26" height="28">
                    <path d="M10,62.5L10,92.5C10,93.881,11.119,95,12.5,95L37.5,95L62.5,95L87.5,95C88.881,95,90,93.881,90,92.5L90,72.5C90,71.119,88.881,70,87.5,70L65,70L65,52.5C65,51.119,63.881,50,62.5,50L37.5,50C36.119,50,35,51.119,35,52.5L35,60L12.5,60C11.119,60,10,61.119,10,62.5ZM65,75L85,75L85,90L65,90L65,75ZM40,62.5L40,55L60,55L60,72.5L60,90L40,90L40,62.5ZM15,65L35,65L35,90L15,90L15,65Z" stroke="none"/><path d="M75,12.5C75,11.119,73.881,10,72.5,10L64.938,10C64.977,9.177,65,8.345,65,7.5C65,6.119,63.881,5,62.5,5L37.5,5C36.119,5,35,6.119,35,7.5C35,8.345,35.023,9.177,35.062,10L27.5,10C26.119,10,25,11.119,25,12.5C25,24.147,34.884,33.755,47.5,34.887L47.5,40L42.5,40C41.119,40,40,41.119,40,42.5S41.119,45,42.5,45L57.5,45C58.881,45,60,43.881,60,42.5S58.881,40,57.5,40L52.5,40L52.5,34.887C65.116,33.755,75,24.147,75,12.5ZM40.063,10L59.936,10C59.326,21.906,54.426,30,49.999,30S40.674,21.906,40.063,10ZM69.796,15C68.934,20.252,65.393,24.754,60.432,27.42C62.327,24.087,63.731,19.83,64.452,15L69.796,15ZM30.204,15L35.548,15C36.269,19.83,37.672,24.087,39.568,27.42C34.606,24.754,31.066,20.252,30.204,15Z" stroke="none"/></svg>
                Leadership Board</li></NavLink>
            </ul>
        </div>
  )
}
